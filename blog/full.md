...
uv、Homebrew、mise、Docker、Cargo、Go など **40 以上**のツールに対応しています。削除するのはキャッシュや古いバージョンだけで、現在使用中のランタイムやパッケージには触れません。

一覧は `sasurahime targets` でいつでも確認できます。主要なものをカテゴリ別に紹介します。
