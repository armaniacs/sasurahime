...
**Untested dry-run guard:** MiseCleaner.
...
| Category | Coverage Before | Critical Gaps | Score |
|---|---|---|---|
| File-system deletion safety | 4/6 cleaners have E2E | Mise uchg, Mise config-pin | 4.2/10 |
| Dry-run integrity | 5/6 tested | **MiseCleaner untested** | 5.0/10 |
| Version key / path guard | Partial | Browser key edge-case | 6.0/10 |
| External tool invocation | 6/6 E2E covered | uchg-retry untested | 6.5/10 |
| Config parsing | ✓ | expand_tilde "~" edge | 8.0/10 |
| Scan / TUI / Output | 8/8 E2E covered | — | 8.5/10 |
| **Overall** | | | **6.3/10** |
...
| HIGH | 2 (GAP-004, GAP-005) |
| MEDIUM | 2 (GAP-003, GAP-010) |
| LOW | 4 (GAP-006~009) |
| **Total** | **10** |
...
> **Total effort estimate:** ~2–3 sprint days (Sprints 5–6)
